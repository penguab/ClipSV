...
def pool_vcf(Chromosomes,prefix):
	...
	SV_out.write('##fileformat=VCFv4.2\n##source=ClipSV##INFO=<ID=SVTYPE,Number=1,Type=String,Description="Type of structural variant">\n##INFO=<ID=SVLEN,Number=.,Type=Integer,Description="Difference in length between REF and ALT alleles">\n##INFO=<ID=BREAKPOINT,Number=.,Type=String,Description="Breakpoint of translocation">\n##ALT=<ID=DEL,Description="Deletion">\n##ALT=<ID=INS,Description="Insertion">\n##ALT=<ID=INV,Description="Inversion">\n##ALT=<ID=TRANS,Description="Translocation">##FORMAT=<ID=GT,Number=1,Type=String,Description="Genotype">##FORMAT=<ID=CR,Number=1,Type=Integer,Description="Number of clipped reads">\n##FORMAT=<ID=NR,Number=1,Type=Integer,Description="Number of non-clipped reads">\n')
